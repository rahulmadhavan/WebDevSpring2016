...
module.exports = function(app, User) {
    ...
    app.get('/api/project/admin/user/:userId', admin, findUserByIdAdmin);
    app.get('/api/project/admin/user', admin, getUsers);
    app.put('/api/project/admin/user/:userId', auth, updateUserById);
    app.delete('/api/project/admin/user/:userId', admin, deleteUserById);

    app.get('/api/project/user/:userId', auth, findUserById);
    app.get('/api/project/user', auth, findUsersByUsernameOrEmail);
    ...
    function findUsersByUsernameOrEmail(req, res) {
        var text = req.query.search;
        User.findUsersByUsernameOrEmail(text)
            .then(function(users) {
                res.json(users);
            });
    }
